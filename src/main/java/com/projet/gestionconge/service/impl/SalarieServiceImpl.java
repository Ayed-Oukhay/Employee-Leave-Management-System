...
public class SalarieServiceImpl implements SalarieService {
    ...
    public SalarieServiceImpl(SalarieRepository salarieRepository, UserRepository userRepository, AuthorityRepository authorityRepository, PasswordEncoder passwordEncoder) {
